...
func (w *WritePointsRequest) AddPoint(name string, value interface{}, timestamp time.Time, tags map[string]string) {
	w.Points = append(w.Points, db.NewPoint(
...
func (w *WriteShardRequest) Points() []db.Point { return w.unmarshalPoints() }

func (w *WriteShardRequest) AddPoint(name string, value interface{}, timestamp time.Time, tags map[string]string) {
	w.AddPoints([]db.Point{db.NewPoint(
		name, tags, map[string]interface{}{"value": value}, timestamp,
	)})
}

func (w *WriteShardRequest) AddPoints(points []db.Point) {
...
func (w *WriteShardRequest) marshalPoints(points []db.Point) []*internal.Point {
...
func (w *WriteShardRequest) unmarshalPoints() []db.Point {
	points := make([]db.Point, len(w.pb.GetPoints()))
