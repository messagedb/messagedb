...
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT load FROM cpu WHERE time = '%s'`, pt1time.Format(sql.DateTimeFormat)),
// 			expected: []string{`{"name":"cpu","values":[{"time":1000000000,"value":42}]}`, `null`},
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT load FROM cpu WHERE time > '%s'`, pt1time.Format(sql.DateTimeFormat)),
...
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT load FROM cpu WHERE time > '%s'`, pt2time.Format(sql.DateTimeFormat)),
// 			expected: []string{`null`},
// 		},
// 	}
//
...
// 		},
// 		{
// 			stmt: fmt.Sprintf(`SELECT sum(value) FROM cpu WHERE time = '%s'`, pt1time.Format(sql.DateTimeFormat)),
// 			expected: []string{
...
// 		},
// 		{
// 			stmt: fmt.Sprintf(`SELECT sum(value) FROM cpu WHERE time > '%s'`, pt2time.Format(sql.DateTimeFormat)),
// 			expected: []string{
...
// }
//
// func openRawMapperOrFail(t *testing.T, shard *Shard, stmt *sql.SelectStatement, chunkSize int) Mapper {
...
// }
//
// func openLocalMapperOrFail(t *testing.T, shard *Shard, stmt *sql.SelectStatement) *LocalMapper {
