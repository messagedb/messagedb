...
const logo = `
                                           _____  ____
                                          |  __ \|  _ \
  _ __ ___   ___  ___ ___  __ _  __ _  ___| |  | | |_) |
 | '_ ' _ \ / _ \/ __/ __|/ _' |/ _' |/ _ \ |  | |  _ <
 | | | | | |  __/\__ \__ \ (_| | (_| |  __/ |__| | |_) |
 |_| |_| |_|\___||___/___/\__,_|\__, |\___|_____/|____/
                                 __/ |
                                |___/
...
func (cmd *Command) Run(args ...string) error {
	...
	if err := cmd.writePIDFile(options.PIDFile); err != nil {
		return fmt.Errorf("writing pid file: %s", err)
	}
	...
	if err := config.Validate(); err != nil {
		return fmt.Errorf("%s. To generate a valid configuration file run `messaged config > messagedb.generated.conf`", err)
	}
	...
	log.Printf("MessageDB starting, version %s, commit %s", cmd.Version, cmd.Commit)
