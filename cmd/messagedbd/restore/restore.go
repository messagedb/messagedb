...
import (
	...
	"github.com/messagedb/messagedb/snapshot"

	"github.com/BurntSushi/toml"
)

// Command represents the program execution for "messaged restore".
type Command struct {
	Stdout io.Writer
	Stderr io.Writer
}
...
func (cmd *Command) printUsage() {
	fmt.Fprintf(cmd.Stderr, `usage: messaged restore [flags] PATH
