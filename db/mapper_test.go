...
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT value FROM cpu WHERE time = '%s'`, pt1time.Format(messageql.DateTimeFormat)),
// 			expected: []string{`{"name":"cpu","values":[{"time":1000000000,"value":42}]}`, `null`},
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT value FROM cpu WHERE time > '%s'`, pt1time.Format(messageql.DateTimeFormat)),
...
// 		},
// 		{
// 			stmt:     fmt.Sprintf(`SELECT value FROM cpu WHERE time > '%s'`, pt2time.Format(messageql.DateTimeFormat)),
// 			expected: []string{`null`},
// 		},
// 	}
//
...
// 		},
// 		{
// 			stmt: fmt.Sprintf(`SELECT sum(value) FROM cpu WHERE time = '%s'`, pt1time.Format(messageql.DateTimeFormat)),
// 			expected: []string{
...
// 		},
// 		{
// 			stmt: fmt.Sprintf(`SELECT sum(value) FROM cpu WHERE time > '%s'`, pt2time.Format(messageql.DateTimeFormat)),
// 			expected: []string{
...
func openRawMapperOrFail(t *testing.T, shard *Shard, stmt *messageql.SelectStatement, chunkSize int) *RawMapper {
...
// func openAggMapperOrFail(t *testing.T, shard *Shard, stmt *messageql.SelectStatement) *AggMapper {
