...
func TestStatementExecutor_ExecuteStatement_CreateDatabase(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`CREATE DATABASE foo`)); res.Err != nil {
		t.Fatal(res.Err)
...
func TestStatementExecutor_ExecuteStatement_DropDatabase(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`DROP DATABASE foo`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_ShowDatabases(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW DATABASES`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
			Name:    "databases",
			Columns: []string{"name"},
			Values: [][]interface{}{
...
func TestStatementExecutor_ExecuteStatement_ShowDatabases_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW DATABASES`)); res.Err == nil || res.Err.Error() != "marker" {
...
func TestStatementExecutor_ExecuteStatement_ShowGrantsFor(t *testing.T) {
	...
	e := NewStatementExecutor()
	e.Store.UserPrivilegesFn = func(username string) (map[string]sql.Privilege, error) {
		if username != "dejan" {
			t.Fatalf("unexpected username: %s", username)
		}
		return map[string]sql.Privilege{
			"dejan": sql.ReadPrivilege,
			"golja": sql.WritePrivilege,
		}, nil
	}

	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW GRANTS FOR dejan`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
...
func TestStatementExecutor_ExecuteStatement_ShowServers(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW SERVERS`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
...
func TestStatementExecutor_ExecuteStatement_ShowServers_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW SERVERS`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_CreateUser(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`CREATE USER susy WITH PASSWORD 'pass' WITH ALL PRIVILEGES`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_CreateUser_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`CREATE USER susy WITH PASSWORD 'pass'`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_SetPassword(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SET PASSWORD FOR susy = 'pass' WITH ALL PRIVILEGES`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_SetPassword_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SET PASSWORD FOR susy = 'pass'`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_DropUser(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`DROP USER susy`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_DropUser_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`DROP USER susy`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_ShowUsers(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW USERS`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
...
func TestStatementExecutor_ExecuteStatement_ShowUsers_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW USERS`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_Grant(t *testing.T) {
	e := NewStatementExecutor()
	e.Store.SetPrivilegeFn = func(username, database string, p sql.Privilege) error {
		if username != "susy" {
			t.Fatalf("unexpected username: %s", username)
		} else if database != "foo" {
			t.Fatalf("unexpected database: %s", database)
		} else if p != sql.WritePrivilege {
			t.Fatalf("unexpected privilege: %s", p)
		}
		return nil
	}

	if res := e.ExecuteStatement(sql.MustParseStatement(`GRANT WRITE ON foo TO susy`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_Grant_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`GRANT READ ON foo TO susy`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_GrantAdmin(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`GRANT ALL TO susy`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_GrantAdmin_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`GRANT ALL PRIVILEGES TO susy`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_Revoke(t *testing.T) {
	...
	e.Store.SetPrivilegeFn = func(username, database string, p sql.Privilege) error {
		if username != "susy" {
			...
			t.Fatalf("unexpected database: %s", database)
		} else if p != sql.NoPrivileges {
			t.Fatalf("unexpected privilege: %s", p)
		}
		return nil
	}

	if res := e.ExecuteStatement(sql.MustParseStatement(`REVOKE ALL PRIVILEGES ON foo FROM susy`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_Revoke_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`REVOKE ALL PRIVILEGES ON foo FROM susy`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_RevokeAdmin(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`REVOKE ALL PRIVILEGES FROM susy`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_RevokeAdmin_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`REVOKE ALL PRIVILEGES FROM susy`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_CreateRetentionPolicy(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`CREATE RETENTION POLICY rp0 ON foo DURATION 2h REPLICATION 3 DEFAULT`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
	}
...
func TestStatementExecutor_ExecuteStatement_CreateRetentionPolicy_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`CREATE RETENTION POLICY rp0 ON foo DURATION 2h REPLICATION 1`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_AlterRetentionPolicy(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`ALTER RETENTION POLICY rp0 ON foo DURATION 7d REPLICATION 2 DEFAULT`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatalf("unexpected error: %s", res.Err)
	}

	stmt = sql.MustParseStatement(`ALTER RETENTION POLICY rp0 ON foo DURATION 7d`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatalf("unexpected error: %s", res.Err)
	}

	stmt = sql.MustParseStatement(`ALTER RETENTION POLICY rp0 ON foo REPLICATION 2`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_AlterRetentionPolicy_Err(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`ALTER RETENTION POLICY rp0 ON foo DURATION 1m REPLICATION 4 DEFAULT`)
...
func TestStatementExecutor_ExecuteStatement_DropRetentionPolicy(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`DROP RETENTION POLICY rp0 ON foo`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_ShowRetentionPolicies(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW RETENTION POLICIES ON db0`)); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
...
func TestStatementExecutor_ExecuteStatement_ShowRetentionPolicies_Err(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW RETENTION POLICIES ON db0`)); res.Err == nil || res.Err.Error() != "marker" {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_ShowRetentionPolicies_ErrDatabaseNotFound(t *testing.T) {
	...
	if res := e.ExecuteStatement(sql.MustParseStatement(`SHOW RETENTION POLICIES ON db0`)); res.Err != meta.ErrDatabaseNotFound {
		t.Fatalf("unexpected error: %s", res.Err)
	}
}
...
func TestStatementExecutor_ExecuteStatement_CreateContinuousQuery(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`CREATE CONTINUOUS QUERY cq0 ON db0 BEGIN SELECT count(*) INTO db1 FROM db0 GROUP BY time(1h) END`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
...
func TestStatementExecutor_ExecuteStatement_DropContinuousQuery(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`DROP CONTINUOUS QUERY cq0 ON db0`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatal(res.Err)
	} else if res.Series != nil {
		t.Fatalf("unexpected rows: %#v", res.Series)
...
func TestStatementExecutor_ExecuteStatement_ShowContinuousQueries(t *testing.T) {
	...
	stmt := sql.MustParseStatement(`SHOW CONTINUOUS QUERIES`)
	if res := e.ExecuteStatement(stmt); res.Err != nil {
		t.Fatal(res.Err)
	} else if !reflect.DeepEqual(res.Series, sql.Rows{
		{
...
func TestStatementExecutor_ExecuteStatement_Unsupported(t *testing.T) {
	...
	func() {
		...
		NewStatementExecutor().ExecuteStatement(
			sql.MustParseStatement(`SELECT count(*) FROM db0`),
		)
	}()
...
type StatementExecutorStore struct {
	...
	SetPrivilegeFn              func(username, database string, p sql.Privilege) error
	SetAdminPrivilegeFn         func(username string, admin bool) error
	UserPrivilegesFn            func(username string) (map[string]sql.Privilege, error)
	UserPrivilegeFn             func(username, database string) (*sql.Privilege, error)
...
func (s *StatementExecutorStore) SetPrivilege(username, database string, p sql.Privilege) error {
...
func (s *StatementExecutorStore) UserPrivileges(username string) (map[string]sql.Privilege, error) {
	return s.UserPrivilegesFn(username)
}

func (s *StatementExecutorStore) UserPrivilege(username, database string) (*sql.Privilege, error) {
